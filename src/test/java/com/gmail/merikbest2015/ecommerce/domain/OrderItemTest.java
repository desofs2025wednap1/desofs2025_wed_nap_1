...
public class OrderItemTest {
    ...
    void constructor_shouldThrowException_whenAmountIsNull() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            new OrderItem(null, 1L, mockPerfume);
        });
    ...
    void constructor_shouldThrowException_whenAmountIsNegative() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            new OrderItem(-1L, 1L, mockPerfume);
        });
        assertEquals("Amount must be non-null and non-negative.", exception.getMessage());
    }
    ...
    void constructor_shouldThrowException_whenQuantityIsNull() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            new OrderItem(10L, null, mockPerfume);
        });
    ...
    void constructor_shouldThrowException_whenQuantityIsZeroOrNegative() {
        ...
        IllegalArgumentException exceptionZero = assertThrows(IllegalArgumentException.class, () -> {
            new OrderItem(10L, 0L, mockPerfume);
        });
        ...
        IllegalArgumentException exceptionNegative = assertThrows(IllegalArgumentException.class, () -> {
            new OrderItem(10L, -5L, mockPerfume);
        });
